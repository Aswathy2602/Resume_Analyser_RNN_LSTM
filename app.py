...
if resume_skills and job_skills:
    ...
    if len(missing_skills) > 0:
        ...
        st.markdown('<div class="missing-skills"><h4>Your resume aligns perfectly with the job requirements! Great job!</h4></div>', unsafe_allow_html=True)
    ...
    if len(recommendations) > 0:
        ...
        st.markdown('<div class="recommendations"><h4>We wish you all the best in your career journey ahead!</h4></div>', unsafe_allow_html=True)
